...
<html lang="en">
<head>
    <title>Code coverage report for src/payment_call_builder.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> payment_call_builder.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
     ...
     */
    forLedger(sequence) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof sequence == 'number') {
<span class="cstat-no" title="statement not covered" >            sequence = sequence.toString();</span>
        }
