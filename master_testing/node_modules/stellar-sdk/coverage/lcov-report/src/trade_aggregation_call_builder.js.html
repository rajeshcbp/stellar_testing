...
<html lang="en">
<head>
    <title>Code coverage report for src/trade_aggregation_call_builder.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> trade_aggregation_call_builder.js
    </h1>
    <div class='clearfix'>
...
export class TradeAggregationCallBuilder extends CallBuilder {
  constructor (serverUrl, base, counter, start_time, end_time, resolution){
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if ((typeof start_time === 'undefined') || (typeof end_time === 'undefined')) {
<span class="cstat-no" title="statement not covered" >        throw new BadRequestError("Invalid time bounds", [start_time, end_time]);</span>
    }else{
        this.url.addQuery("start_time", start_time);
        this.url.addQuery("end_time", end_time);
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.isValidResolution(resolution)) {
<span class="cstat-no" title="statement not covered" >        throw new BadRequestError("Invalid resolution", resolution);</span>
    }else{
