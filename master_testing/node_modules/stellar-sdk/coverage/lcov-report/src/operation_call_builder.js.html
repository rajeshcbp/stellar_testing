...
<html lang="en">
<head>
    <title>Code coverage report for src/operation_call_builder.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> operation_call_builder.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
     ...
     */
    forLedger(sequence) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof sequence == 'number') {
