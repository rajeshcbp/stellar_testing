...
<html lang="en">
<head>
    <title>Code coverage report for src/errors.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> errors.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">Error.subclass = function(errorName) {
  var newError = function(message, data) {
    this.name    = errorName;
    this.message = (message || <span class="branch-1 cbranch-no" title="branch not covered" >"")</span>;
    this.data = data;
  };
&nbsp;
