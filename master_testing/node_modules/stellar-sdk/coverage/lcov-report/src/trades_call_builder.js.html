...
<html lang="en">
<head>
    <title>Code coverage report for src/trades_call_builder.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> trades_call_builder.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y'>
        <span class="strong">17 statements, 15 branches</span>
...
&nbsp;
    ...
    */
    forAssetPair(base, counter) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!base.isNative()) {
<span class="cstat-no" title="statement not covered" >            this.url.addQuery("base_asset_type", base.getAssetType());</span>
<span class="cstat-no" title="statement not covered" >            this.url.addQuery("base_asset_code", base.getCode());</span>
<span class="cstat-no" title="statement not covered" >            this.url.addQuery("base_asset_issuer", base.getIssuer());</span>
        } else {
            this.url.addQuery("base_asset_type", 'native');
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!counter.isNative()) {
...
<span class="cstat-no" title="statement not covered" >            this.url.addQuery("counter_asset_type", 'native');</span>
        }
        return this;
    }
&nbsp;
