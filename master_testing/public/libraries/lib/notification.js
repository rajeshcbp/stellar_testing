  ...
  factory('$notification', ['$timeout',function($timeout){
    ...
    return {
      ...
      info: function(title, content, userData){
        ...
        return this.awesomeNotify('info','glyphicon-info-sign', title, content, userData);
      },

      error: function(title, content, userData){
        return this.awesomeNotify('error', 'glyphicon-remove', title, content, userData);
      },

      success: function(title, content, userData){
        return this.awesomeNotify('success', 'glyphicon-ok', title, content, userData);
      },

      warning: function(title, content, userData){
        return this.awesomeNotify('warning', 'glyphicon-warning-sign', title, content, userData);
      },

      awesomeNotify: function(type, icon, title, content, userData){
        /**
			Home Site:  http://derekries.github.io/angular-notifications/
